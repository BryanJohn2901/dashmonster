...
// Sem sub-filtros embutidos: cada empresa define os seus em
// settings.companyFilters (Painel Admin / wizard), mesclados em
// getInternalFiltersForCategory via mecanismo `custom-filter:`.
